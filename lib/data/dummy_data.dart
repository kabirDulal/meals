...
const availableCategories = [
  ...
  Category(
   ...
   Category(
    id: 'c11',
    title: 'Spanish',
    color: Color.fromARGB(255, 104, 4, 44),
  ),
  Category(
    id: 'c12',
    title: 'Greek Sunrise',
    color: Color.fromARGB(255, 16, 6, 194),
  ),
   Category(
    id: 'c13',
    title: 'Mediterenian',
    color: Color.fromARGB(255, 89, 6, 6),
  ),
  Category(
    id: 'c14',
    title: 'Fat Burner',
    color: Color.fromARGB(255, 55, 1, 49),
  ),
  Category(
    id: 'c15',
    title: 'Aussie HeavyRoos',
    color: Color.fromARGB(255, 12, 214, 26),
  ),
];
const dummyMeals = [
  Meal(
  ...
  Meal(
    ...
    steps: [
      ...
      'Whisk eggs and mix with grated Parmesan.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Spread avocado on toast and sprinkle with chili flakes.'
    ],
    duration: 10,
    complexity: Complexity.simple,
    affordability: Affordability.affordable,
  ...
  Meal(
    ...
    steps: [
      ...
      'Boil and mash potatoes with butter and garlic.',
